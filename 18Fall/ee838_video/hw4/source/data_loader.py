...
def queue_data_dict(file_list, im_size = [28, 28], norm=True, image_resize = True, crop_cord = None, data_format = 'img', mode = 'base'):
	# Batch frame fit into the image size 
	batch_size = len(file_list)
	imgs = []
	gt_labels = []
	...
	for i in range(batch_size):
		...
		if data_format == 'img':
			...
			# example path: '/navi/data/input_data/CityScape/CityScape_train_LR_bicubic/X2/monchengladbach_000000_015126'
